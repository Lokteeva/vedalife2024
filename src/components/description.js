...
<section className="description">
  <div className="description__box">
    ...
    <p> Ведическая культура - это не только изучение древних книг, это чистый образ жизни. И даже танцевать можно так, чтобы этот танец помогал очистить сознание и приблизиться к совершенству жизни.
    </p>
    <p>
    На мастер классе мы познакомимся с культурой современного храмового танца.
    </p>
      </div>
    </div>
  </div>
